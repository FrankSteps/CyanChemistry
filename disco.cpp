...
int main() {
    sf::RenderWindow window(sf::VideoMode(294, 211), "Disco - Frank Steps", sf::Style::Default); 
    ...
    sf::Sprite* currentPlayButton = &sPlay;
    ...
    while (window.isOpen()) {
        ...
        sf::Uint8 r = static_cast<sf::Uint8>(127 + 127 * sin(2 * 3.141590 * time * 0.3));
        sf::Uint8 g = static_cast<sf::Uint8>(127 + 127 * sin(2 * 3.141590 * time * 0.3 + 2));
        sf::Uint8 b = static_cast<sf::Uint8>(127 + 127 * sin(2 * 3.141590 * time * 0.3 + 4));
        songName.setFillColor(sf::Color(r, g, b));
